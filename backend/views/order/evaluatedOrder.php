...
<div  data-content-box="body" ng-app="myApp" ng-controller="evaluatedOrder-controller">
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="box-header search-box">
                            <form bootstrap-table-form="evaluatedOrder-table" class="form-inline search-form">
                                <div class="form-group" style="margin: 5px;">
                                    <label>ID</label>
                                    <input type="text" class="form-control"  name="id"  />
                                </div>
                                <div class="form-group">
                                    <button bootstrap-table-search="evaluatedOrder-table" class="btn btn-outline btn-primary btn-sm"> <i class="fa fa-search icon-white"></i> 搜索</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="box">
                    <div class="box-body">
                        <table id="evaluatedOrder-table"  data-toggle="table" data-show-columns="true" data-autoheight="100" data-show-export="true"
...
<!-- <body></body>后代码块 -->
<?php include '/js/evaluatedOrder.php';?>
<?php $this->endBlock(); ?>