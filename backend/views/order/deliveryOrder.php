                ...
                <div class="box">
                    <div class="box-body">
                        <table id="deliveryOrder-table"  data-toggle="table" data-show-columns="true" data-autoheight="137" data-show-export="true"
                            ...
                            data-id-field="order_id" data-unique-id="order_id" data-table-obj='{"order_status_id":"1002"}' data-custom-url="index.php?r=order/table" class="table  table-hover th-table">
                            <thead>
                                <tr>
