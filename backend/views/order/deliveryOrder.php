...
<div  data-content-box="body" ng-app="myApp" ng-controller="deliveryOrder-controller">
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-body">
                        <table id="deliveryOrder-table"  data-toggle="table" data-show-columns="true" data-autoheight="100" data-show-export="true"
                            data-pagination="true" data-filter-control="true" data-checkbox="true" data-show-export="true"
                            data-id-field="order_id" data-unique-id="order_id" data-method="post" data-content-type="application/x-www-form-urlencoded; charset=UTF-8" data-ajax-options='{"order_status_id":"1002"}' data-custom-url="index.php?r=order/table" class="table  table-hover th-table">
                            <thead>
                                <tr>
...
<!-- <body></body>后代码块 -->
<?php include '/js/deliveryOrder.php';?>
<?php $this->endBlock(); ?>