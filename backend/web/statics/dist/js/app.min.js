    ...
    $.AdminLTE.layout = {
        ...
        $(document).off("click", a + " li a").on("click", a + " li a", function (a) {
            ...
            if (e.is(".treeview-menu") && e.is(":visible") && !$("body").hasClass("sidebar-collapse")) e.slideUp(c, function () {
                ...
                var c_i = d.parent("li").parent("ul").children("li").not(".active").find("i.fa-angle-down");
                c_i.removeClass("fa-angle-down").addClass("fa-angle-left");
                e.parent("li").children("a").children("span").children("i").addClass("fa-angle-left")
                e.parent("li").children("a").children("span").children("i").removeClass("fa-angle-down")
                ...
                e.slideDown(c, function () {
                    ...
                    var c_i = d.parent("li").parent("ul").children("li").not(".active").find("i.fa-angle-down");
                    c_i.removeClass("fa-angle-down").addClass("fa-angle-left");
                    e.parent("li").children("a").children("span").children("i").addClass("fa-angle-down")
                    e.parent("li").children("a").children("span").children("i").removeClass("fa-angle-left")
                })
            }
